...
/// @notice Custom script to upgrade SystemConfig and reinitialize with existing parameters
/// @dev This script:
///      1. Reads environment variables
///      2. Validates ownership chain
///      3. Reads current SystemConfig parameters
///      4. Deploys new SystemConfig implementation
///      5. Upgrades and reinitializes SystemConfig via ProxyAdmin.upgradeAndCall()
///      6. Verifies upgrade
contract UpgradeSystemConfigLocal is Script {
    ...
    /// @notice Perform the complete upgrade process with reinitialization
    function _performUpgradeWithReinit(SystemConfigParams memory params) internal {
        console.log("\n=== Starting SystemConfig Upgrade with Reinitialization ===");
        ...
        // Step 4: Upgrade and reinitialize via Transactor
        console.log("\n--- Upgrading and Reinitializing SystemConfig via Transactor ---");
        ...
        console.log("Upgrade and reinitialization completed successfully");
        ...
        console.log("\n=== SystemConfig Upgrade with Reinitialization Completed Successfully ===");
    }
    ...
    function _verifyUpgradeAndReinit(SystemConfig upgradedSystemConfig, SystemConfigParams memory expectedParams) internal view {
        ...
        console.log("SystemConfig successfully upgraded to version:", newVersion);
        console.log("All existing parameters preserved during reinitialization");
